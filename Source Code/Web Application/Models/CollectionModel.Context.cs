...
namespace EIF.Models
{
    ...
    public partial class CollectionEntities : DbContext
    {
        ...
        public virtual DbSet<CollectorName> CollectorNames { get; set; }
        ...
        public virtual DbSet<Dom_DailyAccountsPayments> Dom_DailyAccountsPayments { get; set; }
        ...
        public virtual int InsertEmployee(string code, string name, Nullable<int> group, Nullable<int> office)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertEmployee", codeParameter, nameParameter, groupParameter, officeParameter);
        }
