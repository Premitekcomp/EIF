...
namespace EIF.Models
{
    ...
    public partial class Dom_DomainsDataExtra
    {
        public Dom_DomainsDataExtra()
        {
            this.Dom_AssignDomainToMembers = new HashSet<Dom_AssignDomainToMembers>();
            this.PCR_PCRHistory = new HashSet<PCR_PCRHistory>();
            this.Dom_AccountsPayments = new HashSet<Dom_AccountsPayments>();
            this.Dom_DailyAccountsPayments = new HashSet<Dom_DailyAccountsPayments>();
        }
        ...
        public virtual ICollection<Dom_AccountsPayments> Dom_AccountsPayments { get; set; }
        public virtual ICollection<Dom_DailyAccountsPayments> Dom_DailyAccountsPayments { get; set; }
