...
namespace EIF.Models
{
    ...
    public partial class UserAccountEntities : DbContext
    {
        ...
        public virtual int pre_UsersEdit(Nullable<short> iD, string displayName, string userName, Nullable<int> group, Nullable<System.DateTime> lADate, Nullable<int> lABy, string branchids)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pre_UsersEdit", iDParameter, displayNameParameter, userNameParameter, groupParameter, lADateParameter, lAByParameter, branchidsParameter);
        }
    
        public virtual int pre_UsersInsert(string displayName, string userName, string password, byte[] image, Nullable<int> group, Nullable<bool> isActive, Nullable<System.DateTime> rCDate, Nullable<int> rCBy, string branchids)
        {
            var displayNameParameter = displayName != null ?
                new ObjectParameter("DisplayName", displayName) :
                new ObjectParameter("DisplayName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pre_UsersInsert", displayNameParameter, userNameParameter, passwordParameter, imageParameter, groupParameter, isActiveParameter, rCDateParameter, rCByParameter, branchidsParameter);
        }
    
        [DbFunction("UserAccountEntities", "SplitDelimiterString")]
        public virtual IQueryable<string> SplitDelimiterString(string stringWithDelimiter, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<string>("[UserAccountEntities].[SplitDelimiterString](@StringWithDelimiter, @Delimiter)", stringWithDelimiterParameter, delimiterParameter);
        }
        ...
        public virtual ObjectResult<Nullable<byte>> Config_AgencyListUpdate(Nullable<byte> iD, string agencyTitle, string branchList, Nullable<bool> isActive)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<byte>>("Config_AgencyListUpdate", iDParameter, agencyTitleParameter, branchListParameter, isActiveParameter);
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByAgencyFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByAgencyFn_Result> DCR_MemberDCRSummaryByAgencyFn(string agencyID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByAgencyFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByAgencyFn](@AgencyID)", agencyIDParameter);
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByAllDomainBothTypeFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByAllDomainBothTypeFn_Result> DCR_MemberDCRSummaryByAllDomainBothTypeFn()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByAllDomainBothTypeFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByAllDomainBothTypeFn]()");
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByAllDomainFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByAllDomainFn_Result> DCR_MemberDCRSummaryByAllDomainFn(string domainType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByAllDomainFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByAllDomainFn](@DomainType)", domainTypeParameter);
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByBranchFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByBranchFn_Result> DCR_MemberDCRSummaryByBranchFn(string branchID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByBranchFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByBranchFn](@BranchID)", branchIDParameter);
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByDomainFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByDomainFn_Result> DCR_MemberDCRSummaryByDomainFn(string domainID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByDomainFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByDomainFn](@DomainID)", domainIDParameter);
        }
    
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByOpenDomainBothTypesFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByOpenDomainBothTypesFn_Result> DCR_MemberDCRSummaryByOpenDomainBothTypesFn()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByOpenDomainBothTypesFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByOpenDomainBothTypesFn]()");
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryByOpenDomainFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryByOpenDomainFn_Result> DCR_MemberDCRSummaryByOpenDomainFn(string domainType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryByOpenDomainFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryByOpenDomainFn](@DomainType)", domainTypeParameter);
        }
        ...
        [DbFunction("UserAccountEntities", "DCR_MemberDCRSummaryFn")]
        public virtual IQueryable<DCR_MemberDCRSummaryFn_Result> DCR_MemberDCRSummaryFn()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<DCR_MemberDCRSummaryFn_Result>("[UserAccountEntities].[DCR_MemberDCRSummaryFn]()");
        }
        ...
        public virtual int Dom_Dom_AccountsPaymentsInsert(string domainId, string pKFieldVal, string pKAliasCol, Nullable<int> versionNumber, Nullable<decimal> paymentValue, string paymentdate)
        {
            var domainIdParameter = domainId != null ?
                new ObjectParameter("DomainId", domainId) :
                new ObjectParameter("DomainId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Dom_Dom_AccountsPaymentsInsert", domainIdParameter, pKFieldValParameter, pKAliasColParameter, versionNumberParameter, paymentValueParameter, paymentdateParameter);
        }
        ...
        public virtual int Dom_GetDynamicColumn(string list, Nullable<int> domainID, string product, string domainttype, string regions, Nullable<bool> myinfoonly)
        {
            var listParameter = list != null ?
                new ObjectParameter("List", list) :
                new ObjectParameter("List", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Dom_GetDynamicColumn", listParameter, domainIDParameter, productParameter, domainttypeParameter, regionsParameter, myinfoonlyParameter);
        }
        ...
        public virtual int DCR_GetDynamicColumn(string list, Nullable<int> domainID)
        {
            var listParameter = list != null ?
                new ObjectParameter("List", list) :
                new ObjectParameter("List", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DCR_GetDynamicColumn", listParameter, domainIDParameter);
        }
    
        public virtual int DeleteDCRData(Nullable<int> domainID)
        {
            var domainIDParameter = domainID.HasValue ?
                new ObjectParameter("DomainID", domainID) :
                new ObjectParameter("DomainID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DeleteDCRData", domainIDParameter);
        }
    
        public virtual int Dom_AccountPaymentsDelete(string domainId)
        {
            var domainIdParameter = domainId != null ?
                new ObjectParameter("DomainId", domainId) :
                new ObjectParameter("DomainId", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Dom_AccountPaymentsDelete", domainIdParameter);
        }
    
        public virtual ObjectResult<DomainsWithPaymentPROC_Result> DomainsWithPaymentPROC()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DomainsWithPaymentPROC_Result>("DomainsWithPaymentPROC");
        }
    
        public virtual int GetSheetColumnName(string name, string domainid)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetSheetColumnName", nameParameter, domainidParameter);
        }
        ...
        public virtual int UserDataScopeEdit(Nullable<int> iD, Nullable<int> bankID, Nullable<int> productID, Nullable<int> typeID, string regionIDS)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UserDataScopeEdit", iDParameter, bankIDParameter, productIDParameter, typeIDParameter, regionIDSParameter);
        }
    
        public virtual int UserDataScopeInsert(Nullable<int> bankID, Nullable<int> productID, Nullable<int> typeID, string regionIDS, Nullable<int> userId)
        {
            var bankIDParameter = bankID.HasValue ?
                new ObjectParameter("BankID", bankID) :
                new ObjectParameter("BankID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UserDataScopeInsert", bankIDParameter, productIDParameter, typeIDParameter, regionIDSParameter, userIdParameter);
        }
    }
}
